...
tokenizer = AutoTokenizer.from_pretrained("keisuke-miyako/bge-m3-lemur-r1-merged")
base = AutoModel.from_pretrained("keisuke-miyako/bge-m3-lemur-r1-merged", torch_dtype=torch.bfloat16)
