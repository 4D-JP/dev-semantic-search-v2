...
register training records
creates: TrainingSearchx2 (includes embeddings)

training queries
↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
TrainingSearch[positive,negative]

once once for r1 only
...
just calculate the cosine similarity for reference
...
*/
		...
		For each ($result; $results)
			...
			If ($batch.success)
				...
				$search.meta:={model: $model; provider: $provider}
				$search.save()
